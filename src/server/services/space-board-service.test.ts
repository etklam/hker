...
describe('space-board-service', () => {
  let boardService: typeof import('@/server/services/space-board-service')
  let spaceService: typeof import('@/server/services/space-service')
  let todoService: typeof import('@/server/services/space-todo-service')
