...
describe('/api/family-todo/spaces/[sid]/lists/[lid]', () => {
  ...
  describe('PATCH', () => {
    it('updates list', async () => {
      ...
      const res = await PATCH(makeReq('/api/family-todo/spaces/1/lists/5', { title: 'Updated' }), { user })
    ...
    it('returns 404 when list not found', async () => {
      ...
      const res = await PATCH(makeReq('/api/family-todo/spaces/1/lists/999', { title: 'X' }), { user })
  ...
  describe('DELETE', () => {
    it('deletes list and returns 204', async () => {
      const res = await DELETE(makeReq('/api/family-todo/spaces/1/lists/5'), { user })
