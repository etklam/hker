...
describe('GET /api/family-todo/spaces/[sid]/members', () => {
  let GET: any
  ...
  it('returns members for space', async () => {
    ...
    const req = new Request('http://localhost:3000/api/family-todo/spaces/1/members') as any
    req.nextUrl = new URL('http://localhost:3000/api/family-todo/spaces/1/members')
