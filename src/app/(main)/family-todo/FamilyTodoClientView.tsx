...
interface Props {
  initialSpaces: FamilyTodoSpace[]
}

export function FamilyTodoClientView({ initialSpaces }: Props) {
  const { t } = useTranslation()
  const { user, loading: authLoading } = useAuth()
  const [spaces, setSpaces] = useState<FamilyTodoSpace[]>(initialSpaces)
